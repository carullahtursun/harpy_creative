...
import profileIconSvg from "@/../public/assets/images/icons/profile_icon.svg";
...
export default function HeaderTwo() {
  ...
  return (
    <>
      <header
        className={`header multiple_header ${isFixedTop ? "fixed_top" : ""}`}
      >
        <div className="header__top">
          <div className="inner row align-items-center mx-auto">
            <div className="col-md-6 col-lg-4 col-xl-4 d-none d-md-block">
              <div className="call d-flex align-items-center gap-1 me-auto">
                <Image src={phoneVolumeRed} alt="phone" className="img-fluid" />
                <p className="call__me m-0 ms-1">Call Me:</p>
                <p className="call__number m-0">(1)245-45678</p>
              </div>
            </div>

            <div className="col-xl-2 col-lg-4 text-xl-end text-lg-center d-none d-lg-block">
              <a href="#" className="top_link me-1">
                Fb.
              </a>
              <a href="#" className="top_link me-1">
                Ln.
            ...
            <div className="col-xl-4 text-xl-end d-none d-xl-block">
              <a href="#" className="top_link me-xxl-4 me-xl-3">
                Advertising
              </a>
              <a href="#" className="top_link me-xxl-4 me-xl-3">
                Development
            ...
            <div className="col-md-6 col-lg-4 col-xl-2 text-md-end text-center">
              <Image src={profileIconSvg} alt="profile_icon" />
              <a href="#" className="top_link ms-2">
                Sign In
              </a>
        ...
        <div className="header__main position-relative mx-auto bg_black row align-items-center">
          ...
          <div className="col-7 col-lg-8 col-xl-6 d-none d-lg-block p-0">
            <div className="header__center d-flex align-items-center justify-content-center">
              <nav id="sideNav" className="mainmenu__nav">
          ...
          <div className="col-6 col-lg-2 col-xl-4 p-0">
            <div className="header__right d-flex align-items-center justify-content-end">
              <Link
                href="contact"
                className="vm_btn fill_btn btn_black btn_17_32 opacity translate_none d-none d-xl-inline-block"
              >
